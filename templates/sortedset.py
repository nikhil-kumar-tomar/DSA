...
class AVLTree:
    ...
    def insert_value(self, value):
        if self.search_value(value) == None:
...
sortedset.insert_value(1)
sortedset.insert_value(2)
sortedset.insert_value(3)
# sortedset.insert_value(4)
sortedset.insert_value(5)
sortedset.insert_value(5)
sortedset.insert_value(5)
# sortedset.delete_value(5)
# sortedset.delete_value(9)
print(sortedset)
print(sortedset.bisect_left(4))
print(sortedset.bisect_right(4))